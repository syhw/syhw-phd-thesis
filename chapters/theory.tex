...
The bot cannot cheat (it is not fun).

\subsection{Randomness}
The bot cannot assume optimal play.

\subsection{Vertical continuity}
Hierarchical models.

\subsection{Horizontal continuity}
Temporal/sequence/filter models.
...
The bot can learn from others games, self past games and self current game.
