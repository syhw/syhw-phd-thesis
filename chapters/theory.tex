...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=12cm]{images/wow_distrib_target_skill.png}
\caption{Log-probabilities of Target and Skill with setup A, and $P(ID_i=true|T=i)=0.9, P(A_i=true|T=i)=0.6$. We can see that if the role of our character is more of a healer, it is most probable that it will heal an ally, even when they are not endangered (setup A).}
