...
The more recent FPS games have dealt with these limitations by using combinations of hierarchical temporal networks (HTN) (Killzone 2 \citep{Killzone2_HTN} and ArmA \citep{ArmA1_HTN}), STRIPS planning (F.E.A.R. \citep{orkinGDC_FEAR}), Behavior trees (Spore, Halo 2 \citep{Isla}). % (Crysis2 BF3)
\begin{color}{red}explain Behavior trees?\end{color}
...
In research, there are cognitive architecture \citep{Laird01} (applied to Quake), multiobjective neuroevolution \citep{Zanetti2004,schrum_cig11competition}, robotics inspired Bayesian models \citep{lehy04}, and various other machine learning approaches \citep{Hladky_anevaluation}. \begin{color}{red}XXX, detail, how much?\end{color}
