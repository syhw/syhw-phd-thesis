...
\item Type: prediction is problem of \textit{inference under uncertainty}; adaptation given what we know is a problem of \textit{planning under constraints}.
