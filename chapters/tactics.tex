...
\item Complexity: at least \textsc{pspace}-complete\footnote{the space of tactics can be seen as a finite combination of possible military actions and geographical positions, and thus tactics can be modeled as a \glos{pomdp}}. %EXPTIME-complete as for Chess and Go \citep{Robson83}). 
