...
%%%39-Observatory, Then Robotic Fac. 
%%%43-make observer 
%%%44-Pylon 
%%%48-Make Reaver 
...
%%%\end{verbatim}
\begin{table}
HERE BO THAT WE FOLLOWED
\end{table}
``Cutting'' workers (here, Probes for Protoss) production is a common feat of highly optimized ``timing attacks'' builds.


At the highest levels of play, StarCraft games usually last between 6 (shortest games, with a successful rush from one of the player) to 30 minutes (long economically and technologically developed game). We now present the evolution of a game following the build order presented in table SEE ABOVE.
