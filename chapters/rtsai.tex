...
\section{Challenges}
In combinatorial game theory terms, competitive StarCraft (1 vs. 1) is a zero sum, partial-information, deterministic strategy game.
...
StarCraft subsumes Wargus, which has an estimated mean branching factor $1.5.10^3$ \citep{LTW} (Chess: $\approx 35$, Go: $<360$). \cite{bgweberPhD} finds a branching factor greater than $1.10^6$ for StarCraft. The game complexity is roughly $10^{11500}$, versus the Shannon number for Chess ($10^{43}$).
