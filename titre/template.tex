...
\usepackage[a4paper]{titre/meta-donnees}
        ...
        \Jury{
            \UGTPresident{M. Augustin Lux}{Professeur \`{a} Grenoble Institut National Polytechnique}
%            \UGTPresidente{...Civilité, Prénom et Nom...}{...titre et affiliation...}

            \UGTRapporteur{M. Stuart Russell}{Professeur \`{a} l'Universit\'{e} de Californie \`{a} Berkeley} %University of California, Berkeley}      %% 1er rapporteur
                \UGTRapporteur{M. Philippe Leray}{Professeur \`{a} l'Ecole Polytechnique de l'Universit\'{e} de Nantes}      %% second rapporteur

                \UGTExaminateur{M. Marc Schoenauer}{Directeur de Recherche \`{a} INRIA \`{a} Saclay}     %% 1er examinateur
                ...
                \UGTDirecteur{M. Pierre Bessi\`{e}re }{Directeur de Recherche au CNRS au Coll\`{e}ge de France}       %% Directeur de thèse
