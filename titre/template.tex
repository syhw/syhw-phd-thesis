...
\usepackage[a4paper]{titre/meta-donnees}
        ...
        \Jury{
            \UGTPresident{Mr Augustin Lux}{Professeur \`{a} Grenoble Institut National Polytechnique}
%            \UGTPresidente{...Civilité, Prénom et Nom...}{...titre et affiliation...}

            \UGTRapporteur{Mr Stuart Russell}{Professeur \`{a} l'Universit\'{e} de Californie \`{a} Berkeley} %University of California, Berkeley}      %% 1er rapporteur
                \UGTRapporteur{Mr Philippe Leray}{Professeur \`{a} l'Ecole Polytechnique de l'Universit\'{e} de Nantes}      %% second rapporteur

                \UGTExaminateur{Mr Marc Schoenauer}{Directeur de Recherche \`{a} INRIA \`{a} Saclay}     %% 1er examinateur
                ...
                \UGTDirecteur{Mr Pierre Bessi\`{e}re }{Directeur de Recherche au CNRS au Coll\`{e}ge de France}       %% Directeur de thèse
